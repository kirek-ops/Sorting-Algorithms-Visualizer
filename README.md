...
3. Put this command to the terminal:
   g++ main.cpp Managers/Column.cpp Managers/EventMan.cpp SortingAlgorithms/bubble.cpp SortingAlgorithms/merge.cpp SortingAlgorithms/quick.cpp SortingAlgorithms/radix.cpp -o f -lsfml-graphics -lsfml-window -lsfml-system; ./f
